...
/**
 * A {@link SignMessagePreProcessor} that transform all sign messages to safe HTML for later inclusion in the IdP UI.
 *
...
public class DefaultSignMessagePreProcessor implements SignMessagePreProcessor {
   ...
   */
  private String markdownToHtml(final String markdown) throws SignMessageContentException {
